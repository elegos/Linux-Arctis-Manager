...
- **[E10-S6a] `vc/inference/` — unified `ort` engine** — ONNX export verified; `providers.rs`, `mel.rs`, and `retrieval.rs` done; the `ort::Session`-loading engine itself not started.
