...
- GNOME Shell extension (45+): same status + configurable quick settings, in the top panel. Ships as its own `linux-arctis-manager-gnome-extension` package, same build matrix as the Plasma widget.
